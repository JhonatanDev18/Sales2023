...
namespace Sales.API.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1017255529", "Jhonatan", "Soto", "soto@yopmail.com", "312 643 1715", "Calle 57D # 24B - 39", "Jhonatan.jpeg",
                UserType.Admin);
            await CheckUserAsync("1010", "Juan", "Zuluaga", "zulu@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "Jhonatan.jpeg", UserType.Admin);
